                        ...
                        <div className="card border shadow-sm">
                            <div className="card-body p-4">
                                <div className="d-flex justify-content-center mb-3">
                                    <span className="rounded-circle bg-success text-white d-inline-flex align-items-center justify-content-center" style={{ width: "56px", height: "56px" }}>
                                        <i className="bi bi-check-lg fs-4"></i>
                                    </span>
                                </div>
                                <h2 className="h2 fw-bold text-center mb-1">Creative Generated Successfully!</h2>
                                <p className="text-secondary text-center mb-4">Your email creative  has been sent to all recipients</p>
                                ...
                                <div className="rounded bg-body-tertiary border p-3 mb-4">
                                ...
                                <button type="button" className="btn btn-primary w-100 mb-2" onClick={() => navigate("/creatives/new")}>
